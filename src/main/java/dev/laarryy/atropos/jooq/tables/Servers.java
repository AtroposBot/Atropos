...
public class Servers extends TableImpl<ServersRecord> {
     ...
     */
    public final TableField<ServersRecord, Long> DATE = createField(DSL.name("date"), SQLDataType.BIGINT.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>atropos.servers.server_id</code>.
     */
    public final TableField<ServersRecord, Long> SERVER_ID = createField(DSL.name("server_id"), SQLDataType.BIGINT.nullable(false), this, "");
