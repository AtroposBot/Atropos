...
public class ChannelDeleteListener {
    ...
    public Mono<Void> on(TextChannelDeleteEvent event) {
        ...
        if (serverProperties.getMemberLogChannelSnowflake().equals(channel.getId().asLong())
                || serverProperties.getMessageLogChannelSnowflake().equals(channel.getId().asLong())
                || serverProperties.getGuildLogChannelSnowflake().equals(channel.getId().asLong())
                || serverProperties.getPunishmentLogChannelSnowflake().equals(channel.getId().asLong())) {
